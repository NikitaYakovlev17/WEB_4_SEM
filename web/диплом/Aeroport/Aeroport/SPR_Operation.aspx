<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SPR_Operation.aspx.cs" Inherits="Aeroport.SPR_Operation" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
 <asp:GridView ID="GridView1" runat="server" AllowSorting="True" 
        ...
        <Columns>
            <asp:BoundField DataField="КодОперации" HeaderText="КодОперации " ReadOnly="true" 
                SortExpression="КодОперации" />
